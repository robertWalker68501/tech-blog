    ...
    <div className='container mt-10'>
      <div className='mb-10 space-y-6'>
        ...
        <div className='mt-10 flex justify-center'>
          <button className='bg-secondary-background cursor-pointer rounded-full border border-white/10 px-8 py-3 text-sm font-medium text-gray-300 transition-all duration-300 hover:border-white/20 hover:text-white'>
            Load more articles
          </button>
        </div>
      </div>
